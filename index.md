...
1.  Wodtke G., Wang W., **Butaeva, K.**, & Durlauf, S. (2026, February). *Class Mobility in the Era of Rising Inequality: A Synthetic Dynasty Analysis*. [🔗 NBER](https://www.nber.org/papers/w34800) 
...
3.  **Butaeva, K.**, & Park, A. (2025, May). *Income Inequality in Chinese Provinces: The Role of Human Capital*. [🔗 SSRN](https://ssrn.com/abstract=5245777)  
    <details style="text-align: justify;">
    <summary style="list-style: disclosure-closed inside; display: list-item;"><strong>Abstract</strong></summary>
...
4.  **Butaeva, K.** (2025, March). *Income Inequality in China, 2012-2018: A New Measurement Approach*. [🔗 SSRN](https://ssrn.com/abstract=5185428)  
    <details style="text-align: justify;">
    <summary style="list-style: disclosure-closed inside; display: list-item;"><strong>Abstract</strong></summary>
...
1.  **Butaeva, K.**, Durlauf, S., & Shapoval A. *Intergenerational Mobility in Late Qing Dynasty (1783-1909): Evidence from Northeast China*.
    <details style="text-align: justify;">
    <summary style="list-style: disclosure-closed inside; display: list-item;"><strong>Abstract</strong></summary>
    The paper examines intergenerational mobility over the final 130 years of the Qing dynasty. We identify two distinct epochs within the 1786–1906 period, each characterized by different mobility dynamics. From 1786 to 1850, mobility patterns appear stable, appearing to converge toward a steady-state class distribution. The second epoch, 1850–1906, exhibits unstable class dynamics across generations until the dynasty's collapse.  The shift between epochs is associated with the Opium Wars and the Taiping Rebellion, demonstrating how the footprints of major crises in the late Qing era can be traced in mobility dynamics. We provide new evidence on long-run mobility trends using Markov-chain measures, showing that intergenerational mobility increased over the final 130 years of the Qing dynasty. This trend persists across alternative mobility concepts, including measures of intergenerational class movement and the persistence of class status (i.e., memory) across generations. We further find that, in the decades preceding the dynasty's collapse, upward mobility declined steadily while downward mobility rose. These patterns may constitute mechanisms contributing to the Qing dynasty's eventual fall. Accordingly, we argue that the basic facts of late-Qing mobility may offer insights into broader historical phenomena. 
    </details>
    
2.  **Butaeva, K.**, & Durlauf, S. *Statistical Models of Intergenerational Mobility*. In *Handbook of the Economics of Intergenerational Mobility*.
    <details style="text-align: justify;">
    <summary style="list-style: disclosure-closed inside; display: list-item;"><strong>Abstract</strong></summary>
...
3.  **Butaeva, K.** *Income Mobility and Public Goods: Evidence from Chinese Provinces*.
    <details style="text-align: justify;">
    <summary style="list-style: disclosure-closed inside; display: list-item;"><strong>Abstract</strong></summary>
...
4.  **Butaeva, K.**, Durlauf, S., & Rudenko D. *Income Inequality and Intergenerational Mobility in Russia*. In *The Oxford Handbook of the Russian Economy*.
